...
export default function RegisterPage() {
  const [formData, setFormData] = useState({
    ...
    fullName: '',
    badge: '',
    role: 'officer' as 'commander' | 'sergeant' | 'officer' | 'analyst',
  });
  ...
  return (
    <div className="min-h-screen bg-[#0a0e17] flex items-start justify-center p-4 pt-8 pb-8 overflow-y-auto">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-1">Join CPAS Command Center</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="w-full px-4 py-2.5 bg-[#1f2937] border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
