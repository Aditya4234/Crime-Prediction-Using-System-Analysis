...
const defaultUsers = [
  {
    ...
    password: "$2b$10$jGU/E6TcBK.dRtU.X1IDIOJGEHG38Zc6tzS34xSvy1EVqxoWLjcO6",
  ...
  },
  {
    ...
    password: "$2b$10$VJdsLy4c2YarfDofOPDUPeKmbqMu50h00Me6RHCzu1LvkK3zimk7i",
...
const defaultIncidents = [
  { id: "CP-2025-0982", type: "Armed Robbery", status: "active", severity: "critical", date: "2025-09-20", location: "142 Main St", victim: "John Smith", suspect: "Unknown Male", officer: "Ofc. Martinez", evidence: 3, witnesses: 2, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  ...
  { id: "CP-2025-0979", type: "Grand Theft Auto", status: "closed", severity: "medium", date: "2025-09-19", location: "780 Parking Deck B", victim: "Mike Wilson", suspect: "Arrested", officer: "Ofc. Chen", evidence: 8, witnesses: 3, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
...
export async function seedDatabase() {
  ...
  const collections = [
    { name: 'users', data: defaultUsers },
    { name: 'incidents', data: defaultIncidents },
    { name: 'alerts', data: defaultAlerts },
    { name: 'units', data: defaultUnits },
    { name: 'messages', data: defaultMessages },
  ];
